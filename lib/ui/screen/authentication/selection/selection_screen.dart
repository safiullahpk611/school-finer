...
class SelectionScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      backgroundColor:
          const Color(0xff851D2A).withOpacity(0.5).withOpacity(0.9),
      appBar: AppBar(
        ...
        title: Text("School Finder",
            style: const TextStyle().s(20).cl(Colors.black)),
      ),
      body: Container(
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              Text("Hello, Welcome !",
                  style: const TextStyle().s(28).cl(Colors.white).w(6)),
              const SizedBox(height: 20),
              Text(
                "To SchoolFinder Top platform for finding Schools",
                style: const TextStyle().s(18).cl(Colors.white).w(4),
  ...
  Widget build(BuildContext context) {
    return InkWell(
      ...
      child: Container(
        ...
        child: Center(
          child: Text(title, style: const TextStyle().s(18).cl(Colors.black)),
        ),
      ),
    );
  }
